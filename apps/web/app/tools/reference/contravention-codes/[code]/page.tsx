...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const description = `What does PCN code ${codeData.code} mean? ${codeData.description}. ${codeData.penaltyLevel === 'higher' ? 'Higher level penalty (£130).' : codeData.penaltyLevel === 'lower' ? 'Lower level penalty (£80).' : 'Fixed penalty notice.'} Learn how to appeal.`;
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                ...
                <span
                  className={`rounded-full px-3 py-1 text-sm font-medium ${
                    codeData.penaltyLevel === 'higher'
                      ? 'bg-coral/10 text-coral'
                      : codeData.penaltyLevel === 'lower'
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="rounded-xl border border-border p-6">
                ...
                <p className="mt-4 text-sm text-gray">
                  Penalties in London may vary. Check your PCN for the exact amount.
                </p>
              </div>
              ...
              <div className="rounded-xl border border-border p-6">
                ...
                <ul className="mt-4 space-y-3 text-gray">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-teal" />
                    <span>You had a valid permit or payment that wasn&apos;t recorded correctly</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-teal" />
                    <span>There were mitigating circumstances (medical emergency, breakdown)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-teal" />
                    <span>The PCN contains errors (wrong date, time, location, vehicle)</span>
                  </li>
                </ul>
                <p className="mt-4 text-sm text-gray">
                  The specific grounds that apply depend on your circumstances. Our AI can
                  help identify the strongest arguments for your case.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-xl bg-dark p-6 text-white">
                ...
                <p className="mt-2 text-sm text-white/80">
                  ...
                  using real tribunal wins for this code.
                </p>
                <Link
                  href="/"
              ...
              {/* Free Template Card */}
              <div className="rounded-xl border border-border p-6">
                <h3 className="font-bold text-dark">Free Appeal Template</h3>
                <p className="mt-2 text-sm text-gray">
                  Not ready for AI? Use our free fill-in-the-blank letter template.
                </p>
                <Link
              ...
              {relatedCodes.length > 0 && (
                <div className="rounded-xl border border-border p-6">
                  ...
                  <p className="mt-1 text-sm text-gray">
                    Other {categoryLabels[codeData.category].toLowerCase()} codes
                  </p>
