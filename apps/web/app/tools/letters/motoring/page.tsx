        ...
        <div className="mx-auto max-w-[1280px] px-6">
          ...
          >
            <div className="mb-4 inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-coral/10">
              <FontAwesomeIcon icon={faCar} className="text-2xl text-coral" />
            </div>
            <h1 className="text-3xl font-bold text-dark md:text-4xl">
              General Motoring Letter Templates
            </h1>
            <p className="mx-auto mt-4 max-w-xl text-gray">
              Free templates for DVLA matters, insurance disputes, dealer
              complaints, and other motoring correspondence.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section ref={templatesRef} className="bg-white py-16 md:py-24">
        <div className="mx-auto max-w-[1280px] px-6">
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {motoringTemplates.map((template, index) => (
              <TemplateCard
                key={template.id}
                template={template}
                index={index}
...
export default MotoringTemplatesPage;
