    ...
    <div className="min-h-screen bg-white">
      ...
      <section ref={heroRef} className="bg-light py-16 md:py-24">
        <div className="mx-auto max-w-[1280px] px-6">
          ...
          >
            <div className="mb-4 inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-amber/10">
              <FontAwesomeIcon
            ...
            <h1 className="text-3xl font-bold text-dark md:text-4xl">
              Bailiff Response Letter Templates
            </h1>
            <p className="mx-auto mt-4 max-w-xl text-gray">
              Free templates for dealing with enforcement agents. Dispute fees,
              request evidence, set up payment plans, and make complaints.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section ref={templatesRef} className="bg-white py-16 md:py-24">
        <div className="mx-auto max-w-[1280px] px-6">
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {bailiffTemplates.map((template, index) => (
              <TemplateCard
                key={template.id}
                template={template}
                index={index}
      ...
      <section className="bg-dark py-16 md:py-20">
        <div className="mx-auto max-w-[1280px] px-6 text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-gray">
            Don&apos;t let it reach bailiff stage. Our AI writes personalised
            appeal letters that have a high success rate.
          </p>
          <Link
            href="/"
...
export default BailiffTemplatesPage;
