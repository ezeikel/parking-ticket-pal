...
export type { LocalAuthorityId, PrivateCompanyId, TransportAuthorityId };
...
export const LOCAL_AUTHORITIES: readonly LocalAuthority[] = [
  {
    id: 'lewisham',
    name: 'Lewisham',
    region: 'London',
...
export const PRIVATE_COMPANIES: readonly PrivateCompany[] = [
  {
    id: 'horizon',
...
export const TRANSPORT_AUTHORITIES: readonly TransportAuthority[] = [
  {
    id: 'tfl',
...
export const CONTRAVENTION_CODES_OPTIONS: readonly {
  value: string;
  label: string;
